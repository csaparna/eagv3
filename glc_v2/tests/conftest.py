...
def _isolated_glc_state(monkeypatch, tmp_path):
    ...
    _cfg.CONFIG_DIR = cfg
    import glc.routes.pairing_store as _p
    ...
    _a._singleton = None
    monkeypatch.setenv("GLC_INSTALL_TOKEN", "test-install-token")
    yield


@pytest.fixture
def unauth_client():
    """TestClient pointed at a freshly-booted glc.main:app without auth headers."""
