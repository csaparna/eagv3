...
def test_pair_without_token_is_unauthorized(unauth_client):
    r = unauth_client.post("/v1/control/pair", json={"channel": "telegram", "channel_user_id": "1"})
    assert r.status_code == 401


def test_pair_with_bad_token_is_forbidden(unauth_client):
